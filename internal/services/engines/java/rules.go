...
func NewXMLParsingVulnerableToXXE() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			ID:            "HS-JAVA-1",
			SafeExample:   SampleSafeHSJAVA1,
			UnsafeExample: SampleVulnerableHSJAVA1,
...
func NewXMLParsingVulnerableToXXEWithXMLInputFactory() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			ID:            "HS-JAVA-2",
			SafeExample:   SampleSafeHSJAVA2,
			UnsafeExample: SampleVulnerableHSJAVA2,
...
func NewXMLParsingVulnerableToXXEWithDocumentBuilder() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			ID:            "HS-JAVA-3",
			SafeExample:   SampleSafeHSJAVA3,
			UnsafeExample: SampleVulnerableHSJAVA3,
...
func NewXMLParsingVulnerableToXXEWithSAXParserFactory() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			ID:            "HS-JAVA-4",
			SafeExample:   SampleSafeHSJAVA4,
			UnsafeExample: SampleVulnerableHSJAVA4,
...
func NewXMLParsingVulnerableToXXEWithTransformerFactory() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			ID:            "HS-JAVA-5",
			SafeExample:   SampleSafeHSJAVA5,
			UnsafeExample: SampleVulnerableHSJAVA5,
...
func NewXMLParsingVulnerableToXXEWithDom4j() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			ID:            "HS-JAVA-7",
			SafeExample:   SampleSafeHSJAVA7,
			UnsafeExample: SampleVulnerableHSJAVA7,
...
func NewXMLParsingVulnerableToXXEWithJdom2() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			ID:            "HS-JAVA-8",
			SafeExample:   SampleSafeHSJAVA8,
			UnsafeExample: SampleVulnerableHSJAVA8,
...
func NewNoListenToClipboard() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			ID:            "HS-JAVA-23",
			SafeExample:   SampleSafeHSJAVA23,
			UnsafeExample: SampleVulnerableHSJAVA23,
...
func NewNoCopyContentToClipboard() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			ID:            "HS-JAVA-24",
			SafeExample:   SampleSafeHSJAVA24,
			UnsafeExample: SampleVulnerableHSJAVA24,
